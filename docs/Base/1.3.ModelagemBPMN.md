...
7. **Evento final (círculo vermelho)**: representa o término do processo da tarefa.
...
5. **Evento final (círculo vermelho)**: indica a finalização do processo da sprint.
...
|  1.2   | 11/04/2025 |          Melhorado o texto da pagina e adicionado mais contexto ao BPMN  |   Lucas Heler   |  |  |
